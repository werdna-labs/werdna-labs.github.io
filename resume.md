...
Minneapolis, MN &middot; July 2017 - August 2018

- Project lead on CradlePoint modem and PBX deployment.
- Managed WAN, telecom systems, and VoIP troubleshooting.
- Administered Mitel PBX and the MiCC Contact Center application.

### Telecom Administrator - RPM Pizza (Domino's)
Gulfport, MS &middot; February 2016 - April 2017

- Managed telecom across more than 400 stores in five states.
- Reduced monthly recurring cost by $15,000 through contract negotiation.
- Provided 24/7 support for CradlePoint, Cisco Meraki, POTS, and T1 circuits.

## Skills

| Area | Detail |
| --- | --- |
| Complex routing | BGP EVPN VXLAN, microsegmentation |
| Security | ClearPass, SRX firewall, SASE |
| Network automation | Python, REST APIs, Model Context Protocol, git |
| Monitoring | IPFIX, SNMP, syslog |
| Packet analysis | Wireshark, tcpdump |
| Containerization | Docker |
| Presales | MEDDPICC |

FOSS enthusiast. Autodidact.

## Certifications

- Aruba Certified Switching Expert
- Aruba Certified Campus Architect
...
**B.Sc. Physics** - Western Michigan University

- Medallion Scholar (highest academic scholarship)
- Lab assistant, Tandem Van de Graaff accelerator
